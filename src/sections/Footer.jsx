...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark py-8 md:py-12 relative overflow-hidden border-t border-white/5">
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-1 space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-400 text-[11px] leading-relaxed max-w-xs mx-auto md:mx-0 font-light px-4 md:px-0">
          ...
          <div className="col-span-1 space-y-4 text-left md:text-left pl-4 md:pl-0">
            <h3 className="text-white font-semibold uppercase tracking-widest text-[9px] opacity-50">Navigation</h3>
          ...
          <div className="col-span-1 space-y-4 text-left md:text-left">
            <h3 className="text-white font-semibold uppercase tracking-widest text-[9px] opacity-50">Follow Me</h3>
          ...
          {/* Contact Info */}
          <div className="col-span-2 md:col-span-1 lg:col-span-1 space-y-4 text-center md:text-left">
            <h3 className="text-white font-semibold uppercase tracking-widest text-[9px] opacity-50">Get in Touch</h3>
            <a 
              href="mailto:wahyudialfurqon109@gmail.com" 
              className="text-white text-xs font-medium hover:text-primary transition-colors duration-300 block break-all px-4 md:px-0"
            >
              wahyudialfurqon109@gmail.com
            </a>
            <p className="text-gray-500 text-[10px] uppercase tracking-widest font-light pt-2">
