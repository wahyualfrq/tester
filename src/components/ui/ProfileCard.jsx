...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)';
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--sunpillar-4': 'hsl(0, 0%, 90%)',
      '--sunpillar-5': 'hsl(0, 0%, 100%)',
    ...
    >
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            {/* Shine layer removed for original photo look */}
            {/* <div style={shineStyle} /> */}

            {/* Glare layer removed for original photo look */}
            ...
            >
                <img
                className="w-full h-full object-cover absolute left-0 top-0 backface-hidden will-change-transform transition-transform duration-[120ms] ease-out"
                src={avatarUrl}
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 6px)) translateY(calc((var(--pointer-from-top) - 0.5) * 6px)) translateZ(0) scale(1.03)',
                  borderRadius: cardRadius
                }}
                onError={e => {
                  const t = e.target;
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: 'linear-gradient(to bottom, #fff, #ccc)',
